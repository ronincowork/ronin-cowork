...
Ronin for, and the kind of feedback. A reply contact is optional. Pressing **Send** approves
...
name. In particular, a reply contact is never stored with the identity of the Ronin install.
