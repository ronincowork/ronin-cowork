...
| Repository contributor instructions and `assignment/DESK_CONTRACT.md` | Developer testing stays with the repository; an actual desk adds its working contract. | Do not inject Ronin's testing machinery into ordinary user births. |
