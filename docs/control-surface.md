...
| Repository contributor instructions and `routine/ronin_worktrees/WORKTREES.md` | Developer testing stays with the repository; the Worktrees Routine's page carries the desk contract. | Do not inject Ronin's testing machinery into ordinary user births. |
