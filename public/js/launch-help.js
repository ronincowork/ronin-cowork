...
function SECTIONS() {
  return [
    ...
    { key: 'behaviours', title: t('help.behaviours', 'What a Behavior is'), body: t('help.behaviours_body', 'Behaviors are specific guidance given to Agents at birth. Write it Down, Planning, Team Work, Visual Staging, and Working with the User are selectable; All Cowork Agents and Conditional Behaviors are applied by Ronin when their rules match.') },
  ];
}
