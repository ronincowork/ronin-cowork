...
export function previewResolved(resolved: Resolved) {
  return {
    ...
    mcpAlways: resolved.mcpAlways,
    mcpDefault: resolved.mcpDefault,
    team_objective: resolved.team_objective,
    team_repos: resolved.team_repos,
    team_branch: resolved.team_branch,
    team_wipeboard: resolved.team_wipeboard,
    team_state: resolved.team_state,
    birth_reading: resolved.birth_reading,
