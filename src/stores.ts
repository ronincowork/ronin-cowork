...
export const STORES: readonly Store[] = [
  {
    ...
    root: 'data',
    rel: 'sessions',
    what: "one session's record — birth README, RIREKI's tape, the scroll, TEGAMI, koshi.json",
  ...
  },
  {
    ...
    root: 'data',
    rel: 'session-boot',
    what: 'transient generated fragments used to compile a session birth README',
