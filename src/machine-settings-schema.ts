...
export const MACHINE_SETTINGS_SCHEMA = {
  ...
  fields: [
    ...
    },
    {
      ...
      sec: 'defaults',
      kind: 'select',
      label: 'Mika model level',
      short: 'Mika model level',
      aside: "Mika is Ronin's own helpful assistant",
      hint: 'Light is recommended. Ronin uses your default provider, then another ready provider at the same level. It never changes levels without you.',
      choices: [
        { value: 'light', label: 'Light — recommended' },
        { value: 'standard', label: 'Standard' },
        { value: 'frontier', label: 'Frontier' },
      ],
      from: 'set.agents.jobs.mikaassist.level',
      seed: 'light',
      lands: { family: 'agents', key: 'jobs.mikaassist.level' },
    },
    {
      id: 'cap',
      sec: 'defaults',
