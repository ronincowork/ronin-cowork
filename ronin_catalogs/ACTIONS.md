...
hand-in tells you so before it creates a candidate or moves a ref: tell the owner, in words,
that the team has no team lead and ask them to mark one on the Team page. Then retry the
same hand-in; never promote around it on your own. A conflict at hand-in is still yours to
