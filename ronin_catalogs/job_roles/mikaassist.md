...
RONIN's own business, not the owner's work. A ROLE and never an act, for `quarterback`'s
reason pointed the other way: she is the one session not doing the owner's work at all, so
a command-shaped name would misfile her among the tasks.
