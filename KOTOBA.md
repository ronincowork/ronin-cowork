...
| **agent_defaults** | user_scope | the Campaign or Team bucket holding values that seed an Agent form: `provider`, `model`, `reach`, `recruit`, `output`, `dial`, `launch_mode` | `CASCADE.md` (ronin-lab) § 4 · `NEW_AGENT.md` § 7.2 |
